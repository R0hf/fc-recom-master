...
<html lang="en">
    ...
    <body>
        <?php
            ...
            $sql=mysqli_query($connect,"SELECT * from viewcounter ");
            $v=mysqli_fetch_assoc($sql);
            $sql2=mysqli_query($connect,"SELECT * from client ");
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="dash.php" class="active"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                            </li>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo$v['views']?></div>
                                        <div>Views</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $countClient;?></div>
                                        <div>Clients members</div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                        ...
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $countAdmin;?></div>
