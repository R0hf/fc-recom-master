                ...
                <div id="book_container">
                    <form action="home.php" method="get" autocomplete="off" >
                        <div id="group_3">
                            <div id="container_5">
                                <label>Search</label>
                                <input type="Search" class="form-control" name="search_booking" id="name_booking" placeholder="<?php echo $_GET['search_booking'] ?>">
                            </div>
                          </div><!-- End group_3 -->
                        <div id="group_1">
                            <div id="container_1">
                                <label>Arrival date</label>
                            	<input class="startDate1 form-control datepick" type="text" data-field="date" data-startend="start" data-startendelem=".endDate1" readonly placeholder="<?php echo $_GET['check_in'] ?>" id="check_in" name="check_in">
                                <span class="input-icon"><i class="icon-calendar-7"></i></span>
                            </div>
                            <div id="container_2">
                                <label>Departure date</label>
                                 <input class="endDate1 form-control datepick" type="text" data-field="date" data-startend="end" data-startendelem=".startDate1" readonly placeholder="<?php echo $_GET['check_out'] ?>" id="check_out" name="check_out" >
                                <span class="input-icon"><i class="icon-calendar-7"></i></span>
                            </div>
                        </div><!-- End group_1 -->
                        <div id="group_2">
                            <div id="container_3">
                                ...
                                <div class="qty-buttons">
                                    ...
                                    <input type="text" name="adults" id="adults" value="<?php echo $_GET['adults'] ?>" class="qty form-control" placeholder="0">
                            ...
                            <div id="container_4">
                                ...
                                <div class="qty-buttons">
                                    ...
                                    <input type="text" name="children" id="children" value="<?php echo $_GET['children'] ?>" class="qty form-control" placeholder="0">
